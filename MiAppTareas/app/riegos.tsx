  ...
  const renderItem = ({ item }: { item: any }) => (
    <View style={styles.item}>
      ...
      <View style={styles.botones}>
        <TouchableOpacity style={styles.btnEditar} onPress={() => editarRiego(item)}><Text>✏️</Text></TouchableOpacity>
        <TouchableOpacity style={styles.btnEliminar} onPress={() => eliminarRiego(item.id)}><Text>🗑️</Text></TouchableOpacity>
      </View>
    </View>
  );
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#f3f4f6" }}>
      <View style={styles.header}>
        <Text style={styles.titulo}>💧 Gestión de Riegos</Text>
        {esAdmin && (
...
const styles = StyleSheet.create({
  ...
  itemTitulo: { fontSize: 18, fontWeight: "bold", color: "#3b82f6" },
